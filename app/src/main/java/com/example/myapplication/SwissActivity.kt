...
import com.example.myapplication.databinding.ActivityEnglandBinding
import com.example.myapplication.databinding.ActivitySwissBinding
import okhttp3.*
...
class SwissActivity : AppCompatActivity() {
    lateinit var binding: ActivitySwissBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySwissBinding.inflate(LayoutInflater.from(this))
    ...
    private fun getData(){
        ...
        val request = Request.Builder()
            .url("https://api.openweathermap.org/data/2.5/weather?q=lausanne&appid=a1a3593bda00a8c6ef840d3f50446c8e&lang=fa&units=metric")
            .build()
