...
class EnglandActivity : AppCompatActivity() {
    lateinit var binding: ActivityEnglandBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEnglandBinding.inflate(LayoutInflater.from(this))
    ...
    private fun getData(){
        ...
        val request = Request.Builder()
            .url("https://api.openweathermap.org/data/2.5/weather?q=london&appid=a1a3593bda00a8c6ef840d3f50446c8e&lang=fa&units=metric")
            .build()
